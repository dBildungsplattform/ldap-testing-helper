...
from migrate_persons.person_helper import create_and_save_log_excel, print_standard_run_statistics
...
def migrate_person_data(log_output_dir, create_person_post_endpoint, create_kontext_post_endpoint, orgas_get_endpoint, roles_get_endpoint, personenkontexte_for_person_get_endpoint, input_path_ldap):
    ...
    print_standard_run_statistics(parser.number_of_found_persons, combined_results['number_of_total_skipped_api_calls'],
    ...
    create_and_save_log_excel(log_output_dir, combined_results['skipped_persons'], combined_results['failed_responses_create_person'], combined_results['failed_responses_create_kontext'], combined_results['schueler_on_school_without_klasse'], combined_results['other_log'])
