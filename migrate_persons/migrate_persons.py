...
def migrate_person_data(create_person_post_endpoint, create_kontext_post_endpoint, input_path_ldap, orgas_get_endpoint, roles_get_endpoint, personenkontexte_for_person_get_endpoint):
    ...
    create_and_save_log_excel(combined_results['skipped_persons'], combined_results['failed_responses_create_person'], combined_results['failed_responses_create_kontext'], combined_results['schueler_on_school_without_klasse'], combined_results['other_log'], migration_log)